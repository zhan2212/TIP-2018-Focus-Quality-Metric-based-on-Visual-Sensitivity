...
% path_data = ['D:\Research 2018\database\TID2013'];
...
axis square
if do_export
    export_fig([pwd, filesep, 'TID2013_Score_Plot_MaxPol_1kernel.pdf'], ...
...
axis square
if do_export
    export_fig([pwd, filesep, 'TID2013_Score_Plot_MaxPol_2kernel.pdf'], ...
        compression_factor, '-transparent')
end
